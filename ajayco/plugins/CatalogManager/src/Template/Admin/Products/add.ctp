...
<section class="content" data-table="products">
    ...
    font-size: 15px;
    font-weight: bold;
">NOTE : All red star mark field should be mandatory. </span>
                                ...
                                <tr id="limage_<?php echo $idc; ?>">
                                    <td>
                                       ...
                                       if (!empty($limage->image) && file_exists($_tdir .$limage->image)) {
											$photo = Router::url("/",true) . 'timthumb.php?src=' . $this->request->webroot."webroot/". $_tdir . $limage->image . '&w=50&h=50&a=t&q=100';
										} else {
