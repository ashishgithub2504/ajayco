...
if (file_exists(ROOT . DS . 'config' . DS . 'settings.yml')) {
    $settings = Yaml::parse(file_get_contents(ROOT . DS . 'config' . DS . 'settings.yml'));
    if(!empty($settings)){
        foreach ($settings AS $settingKey => $settingValue) {
            Configure::write('Setting.'.$settingKey, $settingValue);
        }
    }
}
