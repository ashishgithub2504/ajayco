    ...
    public function initialize()
    {
        ...
        switch ($this->request->getParam('prefix')) {
            ...
            $this->loadComponent('Auth', [
                ...
                $this->Auth->allow(['signup','productdetails','createorder' ,'forgot', 'login', 'passwordreset', 'verifyaccount','index','staticpage','getcategories','getproducts','enquiry','getnavigation','completeorder','getproductlist','getcontact','update','getcategory']);
