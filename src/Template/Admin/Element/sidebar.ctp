    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
         ...
         <li class="treeview <?php echo $custs = (in_array($act, array("index", "add", "edit", "view", 'profile', 'patient', 'doctor')) && (in_array($ctrl, array("adminusers", "admin-users", "users")))) ? "active" : ""; ?>"> <a href="#"> <i class="fa fa-fw fa-user"></i> <span>Users</span> <span class="pull-right-container"> <i class="fa fa-angle-right pull-right"></i> </span> </a>
            ...
            <li class="<?php echo (($act == "index") && $ctrl == "banners") ? "active" : ""; ?>">
                <?php
            ...
            <li class="treeview <?php echo $custs = (in_array($act, array("index", "add", "edit", "view", 'profile', 'patient', 'doctor')) && (in_array($ctrl, array("products","stockstatuses")))) ? "active" : ""; ?>"> <a href="#"> <i class="fa fa-life-ring"></i> <span>Products Manager</span> <span class="pull-right-container"> <i class="fa fa-angle-right pull-right"></i> </span> </a>
                <ul class="treeview-menu <?php echo $custs == "active" ? "menu-open" : ""; ?>">
                    <li class="<?php echo (in_array($act, array("index", "add", "edit", "view", "profile")) && $ctrl == "products") ? "active" : ""; ?>">
                        <?php
                    ...
                    <li class="<?php echo (in_array($act, array("index", "add", "edit", "view", "profile")) && $ctrl == "stockstatuses") ? "active" : ""; ?>">
                        <?php
                        echo $this->Html->link("<i class=\"fa fa-circle-o\"></i> Stock Status", ["controller" => "stock-statuses", "action" => "index", "plugin" => 'CatalogManager'], ["class" => "", "escape" => false]);
            ...
            <li class="<?php echo (($act == "index") && $ctrl == "orders") ? "active" : ""; ?>">
                <?php echo $this->Html->link("<i class=\"fa fa-first-order\"></i> <span>Order Manager</span>", ["controller" => "orders", "action" => "index", "plugin" => null], ["class" => "", "escape" => false]);
                ?>
            </li>
            <li class="<?php echo (($act == "index") && $ctrl == "inquiries") ? "active" : ""; ?>">
                <?php echo $this->Html->link("<i class=\"fa fa-volume-control-phone\"></i> <span>Contact Manager</span>", ["controller" => "inquiries", "action" => "index", "plugin" => "ContactManager"], ["class" => "", "escape" => false]);
                ?>
            </li>
