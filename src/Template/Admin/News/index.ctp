...
<section class="content-header">
    <h1>
        <?= __('Manage News') ?>  
        <small><?php echo __('Here you can manage the news'); ?></small>
    </h1>
        ...
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <div class="box-header">
                    <h3 class="box-title"><span class="caption-subject font-green bold uppercase">List <?= __('News') ?></span></h3>
                    <div class="box-tools">
                        <?= $this->Html->link("<i class=\"fa fa-plus\"></i> " . __('New News'), ["action" => "add"], ["class" => "btn btn-success btn-flat", "escape" => false]) ?>
                    </div>
                </div><!-- /.box-header -->
        ...
        <tbody>
                ...
                <td><?php 
                    if (!empty($banner->image)) { 
                        $photo = Router::url("/",true) . 'timthumb.php?src=' . $this->request->webroot.'img/uploads/news/'.$banner->image.'&w=50&h=50&a=t&q=100';
                        ?>
