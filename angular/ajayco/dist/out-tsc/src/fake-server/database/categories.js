...
export const [shopCategoriesTree, shopCategoriesList] = walkTree('shop', shopCategoriesDef);
export const [blogCategoriesTree, blogCategoriesList] = walkTree('blog', blogCategoriesDef);
...
export function getShopCategoriesTree(parentSlug = null, depth = 0) {
    return getCategoriesTree('shop', parentSlug, depth);
}
export function getBlogCategoriesTree(parentSlug = null, depth = 0) {
    return getCategoriesTree('blog', parentSlug, depth);
}
export function getShopCategoriesBySlugs(slugs, depth = 0) {
...
export function getShopCategory(slug) {
    ...
    return of(JSON.parse(JSON.stringify(Object.assign({}, category, { parents: limitDepth(category.parents, 0), children: limitDepth(category.children, 0) }))));
}
