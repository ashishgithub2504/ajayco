(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
                ...
                function AppComponent(platformId, router, toastr, cart, compare, wishlist, zone, scroller, currency) {
                    ...
                    if (Object(_angular_common__WEBPACK_IMPORTED_MODULE_7__["isPlatformBrowser"])(this.platformId)) {
                        this.zone.runOutsideAngular(function () {
                            _this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_6__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["first"])()).subscribe(function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RootComponent = /** @class */ (function () {
                function RootComponent(router, route) {
                    var _this = this;
                    this.router = router;
                    this.route = route;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BlockBrandsComponent = /** @class */ (function () {
                function BlockBrandsComponent(root, direction) {
                    this.root = root;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BlockCategoriesComponent = /** @class */ (function () {
                function BlockCategoriesComponent(root) {
                    this.root = root;
                    this.header = '';
                    this.layout = 'classic';
                    this.categories = [];
            ...
            BlockCategoriesComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var BlockProductColumnsItemComponent = /** @class */ (function () {
                function BlockProductColumnsItemComponent() {
                    this.classCol = true;
                    this.products = [];
                }
                return BlockProductColumnsItemComponent;
            }());
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BlockSlideshowComponent = /** @class */ (function () {
                function BlockSlideshowComponent(sanitizer, http, direction) {
                ...
                BlockSlideshowComponent.prototype.apicall = function () {
                    var _this = this;
                    this.http
                        .get(this.APIURL + "index")
                        .subscribe(function (response) {
                        _this.result = response.data;
                        _this.slides = response.data.banner_images;
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DepartmentsComponent = /** @class */ (function () {
                ...
                DepartmentsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.service.getNavigation().subscribe(function (data) {
                        _this.items = data;
                    });
                ...
                DepartmentsComponent.prototype.onItemMouseEnter = function (item) {
                    this.hoveredItem = item;
                };
                DepartmentsComponent.prototype.onItemMouseLeave = function (item) {
                    if (this.hoveredItem === item) {
                        this.hoveredItem = null;
                    }
                };
                DepartmentsComponent.prototype.onItemClick = function () {
                    this.close();
                };
                DepartmentsComponent.prototype.onSubItemClick = function () {
                    this.close();
                    this.hoveredItem = null;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LinksComponent = /** @class */ (function () {
                function LinksComponent(direction, ShopService) {
                    this.direction = direction;
                ...
                LinksComponent.prototype.ngOnInit = function () {
                    ...
                    this.isLoggedIn$.subscribe(function (value) { return _this.loginValue = value; });
                ...
                LinksComponent.prototype.onItemMouseEnter = function (item, event) {
                    this.hoveredItem = item;
                ...
                LinksComponent.prototype.onItemMouseLeave = function (item) {
                    if (this.hoveredItem === item) {
                        this.hoveredItem = null;
                    }
                };
                LinksComponent.prototype.onSubItemClick = function () {
                    this.hoveredItem = null;
                };
                return LinksComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MenuComponent = /** @class */ (function () {
                ...
                MenuComponent.prototype.onItemMouseEnter = function (item) {
                    this.hoveredItem = item;
                };
                MenuComponent.prototype.onItemMouseLeave = function (item) {
                    if (this.hoveredItem === item) {
                        this.hoveredItem = null;
                    }
                };
                MenuComponent.prototype.onSubItemClick = function (item) {
                    this.hoveredItem = null;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
             ...
             */
            var PageCategoryService = /** @class */ (function () {
                /**
                 * This service serves as a mediator between the PageCategoryComponent, ProductsViewComponent and WidgetFiltersComponent components.
                 */
                function PageCategoryService() {
                    ...
                    this.list$ = this.listSource.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (x) { return x !== null; }));
                    // options
                    this.optionsState = {};
                    this.optionsChange$ = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
                }
                Object.defineProperty(PageCategoryService.prototype, "options", {
                    get: function () {
                ...
                Object.defineProperty(PageCategoryService.prototype, "items", {
                    // getters for list
                    get: function () { return this.listState.items; },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(PageCategoryService.prototype, "page", {
                    get: function () { return this.listState.page; },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(PageCategoryService.prototype, "limit", {
                    get: function () { return this.listState.limit; },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(PageCategoryService.prototype, "sort", {
                    get: function () { return this.listState.sort; },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(PageCategoryService.prototype, "total", {
                    get: function () { return this.listState.total; },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(PageCategoryService.prototype, "pages", {
                    get: function () { return this.listState.pages; },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(PageCategoryService.prototype, "from", {
                    get: function () { return this.listState.from; },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(PageCategoryService.prototype, "to", {
                    get: function () { return this.listState.to; },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(PageCategoryService.prototype, "filters", {
                    get: function () { return this.listState.filters; },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(PageCategoryService.prototype, "filterValues", {
                    get: function () { return this.listState.filterValues; },
                    enumerable: true,
                    configurable: true
                });
                // set functions
                PageCategoryService.prototype.setIsLoading = function (value) {
                    this.isLoadingState = value;
                    this.isLoadingSource.next(value);
                };
                PageCategoryService.prototype.setList = function (list) {
                    this.listState = list;
                    this.listSource.next(this.listState);
                };
                PageCategoryService.prototype.setOptions = function (options, emitEvent) {
                    if (emitEvent === void 0) { emitEvent = true; }
                    var diff = this.optionsDiff(options);
                ...
                PageCategoryService.prototype.updateOptions = function (options, emitEvent) {
                    if (emitEvent === void 0) { emitEvent = true; }
                 ...
                 */
                PageCategoryService.prototype.optionsDiff = function (curr) {
                    var _this = this;
                    var result = {};
                    ['page', 'limit', 'sort'].forEach(function (key) {
                        if (key in curr && _this[key] !== curr[key]) {
                            result[key] = curr[key];
                        }
                    });
                    if ('filterValues' in curr) {
                        var filterValues_1 = curr.filterValues;
                        if (Object.keys(filterValues_1).length !== Object.keys(this.filterValues).length) {
                            result.filterValues = {};
                        }
                        Object.keys(filterValues_1).forEach(function (key) {
                            if (_this.filterValues[key] !== filterValues_1[key]) {
                                if (!('filterValues' in result)) {
                                    result.filterValues = {};
                                }
                                result.filterValues[key] = filterValues_1[key];
                            }
                        });
                    }
                    return result;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WidgetCategoriesComponent = /** @class */ (function () {
                function WidgetCategoriesComponent(root) {
                    this.root = root;
                    this.location = 'blog';
                    this.categories = [];
                }
            ...
            WidgetCategoriesComponent.ctorParameters = function () { return [
                { type: _shared_services_root_service__WEBPACK_IMPORTED_MODULE_2__["RootService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WidgetFiltersComponent = /** @class */ (function () {
                function WidgetFiltersComponent(platformId, direction, fb, root, pageCategory) {
                    this.platformId = platformId;
                    this.direction = direction;
                    this.fb = fb;
                    this.root = root;
                ...
                WidgetFiltersComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.pageCategory.list$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (x) { return x.filters; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["takeUntil"])(this.destroy$)).subscribe(function (filters) {
                        _this.filters = filters;
                        _this.filtersForm = _this.makeFiltersForm(filters);
                        _this.filtersForm.valueChanges.subscribe(function (formValues) {
                            _this.pageCategory.updateOptions({
                                filterValues: _this.convertFormToFilterValues(filters, formValues)
                            });
                        });
                    });
                };
                WidgetFiltersComponent.prototype.ngOnDestroy = function () {
                    this.destroy$.next();
                    this.destroy$.complete();
                };
                WidgetFiltersComponent.prototype.trackBySlug = function (index, item) {
                    return item.slug;
                };
                WidgetFiltersComponent.prototype.makeFiltersForm = function (filters) {
                    var _this = this;
                    var filtersFromGroup = {};
                    filters.forEach(function (filter) {
                        switch (filter.type) {
                            case 'range':
                            case 'radio':
                                filtersFromGroup[filter.slug] = _this.fb.control(filter.value);
                                break;
                            case 'check':
                            case 'color':
                                filtersFromGroup[filter.slug] = _this.makeListFilterForm(filter);
                                break;
                        }
                    });
                    return this.fb.group(filtersFromGroup);
                };
                WidgetFiltersComponent.prototype.makeListFilterForm = function (filter) {
                    var _this = this;
                    var group = {};
                    filter.items.forEach(function (item) {
                        var control = _this.fb.control(filter.value.includes(item.slug));
                        // A timeout is needed because sometimes a state change is ignored if performed immediately.
                        setTimeout(function () {
                            if (_this.isItemDisabled(filter, item)) {
                ...
                WidgetFiltersComponent.prototype.isItemDisabled = function (filter, item) {
                    return item.count === 0 && (filter.type === 'radio' || !filter.value.includes(item.slug));
                };
                WidgetFiltersComponent.prototype.convertFormToFilterValues = function (filters, formValues) {
                    var filterValues = {};
                    filters.forEach(function (filter) {
                        var formValue = formValues[filter.slug];
                        switch (filter.type) {
                            case 'range':
                            ...
                            case 'check':
                            case 'color':
                                var filterFormValues_1 = formValue || {};
                                ...
                                filter.value.forEach(function (filterValue) {
                                    if (!(filterValue in filterFormValues_1)) {
                                        filterFormValues_1[filterValue] = true;
                                    }
                                });
                                var values = Object.keys(filterFormValues_1).filter(function (x) { return filterFormValues_1[x]; });
                                if (values.length > 0) {
                ...
                WidgetFiltersComponent.prototype.reset = function () {
                    var formValues = {};
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PageHomeOneComponent = /** @class */ (function () {
                function PageHomeOneComponent(shop) {
                    this.shop = shop;
                    this.destroy$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
                }
                PageHomeOneComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    this.shop.getIndex().subscribe(function (data) {
                        _this.posts = data;
                    });
                    this.groupChange(this.latestProducts, this.latestProducts.groups[0]);
                };
                PageHomeOneComponent.prototype.ngOnDestroy = function () {
                    this.destroy$.next();
                    this.destroy$.complete();
                };
                PageHomeOneComponent.prototype.groupChange = function (carousel, group) {
                    carousel.loading = true;
                    carousel.abort$.next();
                    group.products$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return carousel.loading = false; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(this.destroy$, carousel.abort$))).subscribe(function (x) { return carousel.products = x; });
                };
                return PageHomeOneComponent;
            }());
            PageHomeOneComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PageHomeTwoComponent = /** @class */ (function () {
                function PageHomeTwoComponent(shop) {
                    this.shop = shop;
                    this.destroy$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Subject"]();
                    this.posts = _data_blog_posts__WEBPACK_IMPORTED_MODULE_2__["posts"];
                }
                PageHomeTwoComponent.prototype.ngOnInit = function () {
                    this.bestsellers$ = this.shop.getBestsellers(7);
                    this.brands$ = this.shop.getPopularBrands();
                    this.popularCategories$ = this.shop.getCategoriesBySlug([
                        'power-tools',
                ...
                PageHomeTwoComponent.prototype.ngOnDestroy = function () {
                    this.destroy$.next();
                    this.destroy$.complete();
                };
                PageHomeTwoComponent.prototype.groupChange = function (carousel, group) {
                    carousel.loading = true;
                    carousel.abort$.next();
                    group.products$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return carousel.loading = false; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["merge"])(this.destroy$, carousel.abort$))).subscribe(function (x) { return carousel.products = x; });
                };
                return PageHomeTwoComponent;
            }());
            PageHomeTwoComponent.ctorParameters = function () { return [
                { type: _shared_api_shop_service__WEBPACK_IMPORTED_MODULE_3__["ShopService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShopService = /** @class */ (function () {
                ...
                Object.defineProperty(ShopService.prototype, "isLoggedIn", {
                    get: function () {
                 ...
                 */
                ShopService.prototype.getCategory = function (slug) {
                    /**
                 ...
                 */
                ShopService.prototype.getCategories = function (parent, depth) {
                 ...
                 * @param depth - Maximum depth of category tree.
                 */
                ShopService.prototype.getCategoriesBySlug = function (slugs, depth) {
                    if (depth === void 0) { depth = 0; }
                    /**
                     * This is what your API endpoint might look like:
                     *
                 ...
                 */
                ShopService.prototype.getProductsList = function (categorySlug, options) {
                    /**
                     * This is what your API endpoint might look like:
                     *
                ...
                ShopService.prototype.getProduct = function (productSlug) {
                    /**
                     * This is what your API endpoint might look like:
                     *
                    ...
                    return this.http.get(this.APIURL + 'productdetails', { params: params })
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.data; }));
                    // This is for demonstration purposes only. Remove it and use the code above.
                 ...
                 */
                ShopService.prototype.getPopularBrands = function () {
                    /**
                     * This is what your API endpoint might look like:
                     *
                ...
                ShopService.prototype.getBestsellers = function (limit) {
                    ...
                    return this.http.get(this.APIURL + 'getproducts', { params: params })
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.data; }));
                    // This is for demonstration purposes only. Remove it and use the code above.
                    // return getBestsellers(limit);
                };
                ShopService.prototype.getTopRated = function (limit) {
                    if (limit === void 0) { limit = null; }
                    /**
                     * This is what your API endpoint might look like:
                     *
                ...
                ShopService.prototype.getSpecialOffers = function (limit) {
                    if (limit === void 0) { limit = null; }
                    /**
                     * This is what your API endpoint might look like:
                     *
                ...
                ShopService.prototype.getFeaturedProducts = function (categorySlug, limit) {
                    if (categorySlug === void 0) { categorySlug = null; }
                    if (limit === void 0) { limit = null; }
                    /**
                     * This is what your API endpoint might look like:
                     *
                ...
                ShopService.prototype.getLatestProducts = function (categorySlug, limit) {
                    if (categorySlug === void 0) { categorySlug = null; }
                    if (limit === void 0) { limit = null; }
                    /**
                     * This is what your API endpoint might look like:
                ...
                ShopService.prototype.getRelatedProducts = function (product) {
                    /**
                     * This is what your API endpoint might look like:
                     *
                ...
                ShopService.prototype.getStatic = function (slug) {
                    return this.http.get(this.APIURL + 'staticpage?name=' + slug)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.data; }));
                };
                ShopService.prototype.getContact = function () {
                    return this.http.get(this.APIURL + 'getcontact')
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.data; }));
                };
                ShopService.prototype.getIndex = function () {
                    return this.http.get(this.APIURL + 'index')
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.data; }));
                };
                ShopService.prototype.getLogin = function (detail) {
                    var _this = this;
                    this.http.post(this.APIURL + 'login', {
                        ...
                        if (_this.result.status == true) {
                            ...
                            localStorage.setItem('USERINFO', JSON.stringify(_this.result.data));
                ...
                ShopService.prototype.getLogout = function () {
                    this.loggedIn.next(false);
                    localStorage.removeItem("USERINFO");
                    this.router.navigate(['/account/login']);
                };
                ShopService.prototype.signup = function (detail) {
                    return this.http.post(this.APIURL + 'signup', {
                        detail: detail
                    }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (response) { return response.data; }));
                };
                ShopService.prototype.update = function (detail) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var InputNumberComponent = InputNumberComponent_1 = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PaginationComponent = PaginationComponent_1 = /** @class */ (function () {
                ...
                PaginationComponent.prototype.setPage = function (value, emitEvent) {
                    if (emitEvent === void 0) { emitEvent = true; }
                    this.onTouched();
                ...
                PaginationComponent.prototype.writeValue = function (obj) {
                    if (typeof obj === 'number') {
            ...
            PaginationComponent = PaginationComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
                    ...
                    providers: [
                        {
                            provide: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NG_VALUE_ACCESSOR"],
                            useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () { return PaginationComponent_1; }),
                            multi: true
                        }
                    ],
            ...
            var ProductCardComponent = /** @class */ (function () {
                ...
                ProductCardComponent.prototype.ngOnChanges = function (changes) {
                    if ('product' in changes) {
                        this.featuredAttributes = !this.product ? [] : this.product.attributes.filter(function (x) { return x.featured; });
                    }
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductComponent = /** @class */ (function () {
                function ProductComponent(platformId, cart, wishlist, compare, photoSwipe, direction) {
                    this.platformId = platformId;
                    this.cart = cart;
                    this.wishlist = wishlist;
                    this.compare = compare;
                ...
                ProductComponent.prototype.getIndexDependOnDir = function (index) {
                    ...
                    if (this.layout !== 'quickview') {
                        ...
                        var options = {
                            getThumbBoundsFn: function (index) {
                                var imageElements = _this.imageElements.toArray();
                                var dirDependentIndex = _this.getIndexDependOnDir(index);
                                if (!imageElements[dirDependentIndex]) {
                                    return null;
                                }
                                var imageElement = imageElements[dirDependentIndex].nativeElement;
                        ...
                        this.photoSwipe.open(images, options).subscribe(function (galleryRef) {
                            galleryRef.listen('beforeChange', function () {
                                _this.featuredCarousel.to(_this.images[_this.getIndexDependOnDir(galleryRef.getCurrentIndex())].id);
                            });
                        });
                    }
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function hexToRgb(hex) {
                ...
                var rgb;
                if (hex.length === 3) {
                    rgb = hex.match(/./g).map(function (x) { return x + x; });
                }
                else {
                    rgb = hex.match(/.{2}/g);
                }
                return rgb.map(function (x) { return parseInt(x, 16); });
            }
            function luminance(color) {
                ...
                rgb = rgb.map(function (x) { return x / 255; }).map(function (x) {
                    if (x <= 0.03928) {
                        return x / 12.92;
                    }
                    else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ColorTypePipe = /** @class */ (function () {
                function ColorTypePipe() {
                }
                ColorTypePipe.prototype.transform = function (value) {
                    return Object(_helpers_color__WEBPACK_IMPORTED_MODULE_2__["colorType"])(value);
                };
                return ColorTypePipe;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DepartmentsService = /** @class */ (function () {
                ...
                DepartmentsService.prototype.getNavigation = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ResourcesService = ResourcesService_1 = /** @class */ (function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RootService = /** @class */ (function () {
                ...
                RootService.prototype.home = function () {
                    return '/';
                };
                RootService.prototype.shop = function () {
                    return "/shop/catalog";
                };
                RootService.prototype.category = function (category) {
                    if (category.type === 'shop') {
                        var basePath = this.shop();
                        if ('slug' in category) {
                ...
                RootService.prototype.product = function (product) {
                    var basePath = '/shop/products';
                    if ('slug' in product) {
                ...
                RootService.prototype.brand = function (brand) {
                    return '/';
                };
                RootService.prototype.cart = function () {
                    return '/shop/cart';
                };
                RootService.prototype.checkout = function () {
                    return '/shop/cart/checkout';
                };
                RootService.prototype.wishlist = function () {
                    return '/shop/wishlist';
                };
                RootService.prototype.blog = function () {
                    return '/blog';
                };
                RootService.prototype.post = function () {
                    return "/blog/post-classic";
                };
                RootService.prototype.login = function () {
                    return '/account/login';
                };
                RootService.prototype.terms = function () {
                    return '/site/terms';
                };
                RootService.prototype.notFound = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var StoreService = /** @class */ (function () {
                ...
                Object.defineProperty(StoreService.prototype, "logo", {
                    get: function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var brands = brandsDef.map(function (brandDef) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function walkTree(categoriesType, categoriesDef, parents) {
                ...
                var list = [];
                var tree = categoriesDef.map(function (categoryDef) {
                    var category = {
                        id: ++lastCategoryId,
                        type: categoriesType,
                        name: categoryDef.name,
                        slug: categoryDef.slug,
                        path: parents.map(function (x) { return x.slug; }).concat([categoryDef.slug]).join('/'),
                    ...
                    var _a = walkTree(categoriesType, categoryDef.children || [], parents.concat([category])), childrenTree = _a[0], childrenList = _a[1];
                    category.children = childrenTree;
                    list = list.concat([category], childrenList);
                    return category;
                });
                return [tree, list];
            }
            var _a = walkTree('shop', shopCategoriesDef), shopCategoriesTree = _a[0], shopCategoriesList = _a[1];
            var _b = walkTree('blog', blogCategoriesDef), blogCategoriesTree = _b[0], blogCategoriesList = _b[1];
            ...
            function getCategoriesTree(categoriesType, parentSlug, depth) {
                if (parentSlug === void 0) { parentSlug = null; }
                if (depth === void 0) { depth = 0; }
                var categories = [];
                var list = categoriesType === 'shop' ? shopCategoriesList : blogCategoriesList;
                var tree = categoriesType === 'shop' ? shopCategoriesTree : blogCategoriesTree;
                if (parentSlug === null) {
                    categories = tree.slice();
                }
                else {
                    var parent = list.find(function (x) { return x.slug === parentSlug; });
                    if (!parent) {
            ...
            function getShopCategoriesTree(parentSlug, depth) {
                if (parentSlug === void 0) { parentSlug = null; }
                if (depth === void 0) { depth = 0; }
                return getCategoriesTree('shop', parentSlug, depth);
            }
            function getBlogCategoriesTree(parentSlug, depth) {
                if (parentSlug === void 0) { parentSlug = null; }
                if (depth === void 0) { depth = 0; }
                return getCategoriesTree('blog', parentSlug, depth);
            }
            function getShopCategoriesBySlugs(slugs, depth) {
                if (depth === void 0) { depth = 0; }
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(limitDepth(shopCategoriesList.filter(function (x) { return slugs.includes(x.slug); }), depth));
            }
            function getShopCategory(slug) {
                var category = shopCategoriesList.find(function (x) { return x.slug === slug; });
                if (!category) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var products = productsDef.map(function (productDef) {
                var badges = [];
                if (productDef.badges) {
                    badges = typeof productDef.badges === 'string' ? [productDef.badges] : productDef.badges;
                }
                var categories = _categories__WEBPACK_IMPORTED_MODULE_2__["shopCategoriesList"].filter(function (x) { return productDef.categories.includes(x.slug); }).map(function (x) { return (Object.assign({}, x, { parents: null, children: null })); });
                var attributes = (productDef.attributes || []).map(function (productAttributeDef) {
                    var attributeDef = attributesDef.find(function (x) { return x.slug === productAttributeDef.slug; });
                    if (!attributeDef) {
                        return null;
                    }
                    var valuesDef = [];
                    ...
                    var values = valuesDef.map(function (valueSlug) {
                        var valueDef = attributeDef.values.find(function (x) { return x.slug === valueSlug; });
                        if (!valueDef) {
                            return null;
                        }
                ...
                return {
                    ...
                    brand: _brands__WEBPACK_IMPORTED_MODULE_1__["brands"].find(function (x) { return x.slug === productDef.brand; }) || null,
            ...
            function getFeatured(categorySlug, limit) {
                if (categorySlug === void 0) { categorySlug = null; }
                if (limit === void 0) { limit = null; }
                var fakeProducts = products.slice();
                if (categorySlug === 'power-tools') {
                    fakeProducts = fakeProducts.reverse();
                }
                else if (categorySlug === 'hand-tools') {
                    fakeProducts = fakeProducts.slice(8).concat(fakeProducts.slice(0, 8));
                }
                else if (categorySlug === 'plumbing') {
                    fakeProducts = fakeProducts.slice(8).concat(fakeProducts.slice(0, 8)).reverse();
                }
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["timer"])(1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function () { return fakeProducts.slice(0, limit || undefined); }));
            }
            function getLatestProducts(categorySlug, limit) {
                if (categorySlug === void 0) { categorySlug = null; }
                if (limit === void 0) { limit = null; }
                return getFeatured(categorySlug, limit);
            }
            ...
            function getProduct(productSlug) {
                var product = products.find(function (x) { return x.slug === productSlug; });
                if (!product) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            function getProductsList(categorySlug, options) {
                ...
                var items = _database_products__WEBPACK_IMPORTED_MODULE_4__["products"].slice();
                // Make filters.
                if (categorySlug === null) {
                    filters.push({
                        ...
                        name: 'Categories',
                        root: true,
                        items: _database_categories__WEBPACK_IMPORTED_MODULE_6__["shopCategoriesTree"].map(function (x) { return makeCategoryFilterItem('child', x); }).slice(),
                    });
                }
                else {
                    var category = _database_categories__WEBPACK_IMPORTED_MODULE_6__["shopCategoriesList"].find(function (x) { return x.slug === categorySlug; });
                    if (!category) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["throwError"])(new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpErrorResponse"]({ status: 404, statusText: 'Page Not Found' }));
                    }
                    filters.push({
                        ...
                        name: 'Categories',
                        root: false,
                        items: category.parents.map(function (x) { return makeCategoryFilterItem('parent', x); }).concat([
                            makeCategoryFilterItem('current', category)
                        ], category.children.map(function (x) { return makeCategoryFilterItem('child', x); })),
                    });
                }
                makeFilters(filtersDef, items).forEach(function (x) { return filters.push(x); });
                ...
                filters.forEach(function (filter) {
                    ...
                    var counts = calcProductsForFilterValues(filter, filters, items);
                    filter.items.forEach(function (item) {
                ...
                items = items.filter(function (product) {
                    return filters.reduce(function (result, filter) { return result && testProduct(filter, product); }, true);
                });
                // Sort items array.
                ...
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["timer"])(350).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function () { return JSON.parse(JSON.stringify(response)); }));
            }
            function getFilterValue(type, slug, product, defaultValue) {
                ...
                if (type === 'range' && slug === 'price') {
                    ...
                    var attribute = product.attributes.find(function (x) { return x.slug === slug; });
                    if (!attribute) {
                        return defaultValue;
                    }
                    return attribute.values.map(function (x) { return ({ slug: x.slug, name: x.name }); });
                }
                return defaultValue;
            }
            function getRangeValue(slug, product, defaultValue) {
                if (defaultValue === void 0) { defaultValue = null; }
            ...
            function parseFilterValue(filter, value) {
                switch (filter.type) {
                    ...
                    case 'check':
                    case 'color':
                        return value.trim() === '' ? [] : value.split(',').map(function (x) { return x.trim(); });
                }
                return value;
            }
            function testProduct(filter, product) {
                if (filter.type === 'range') {
                    var value = getRangeValue(filter.slug, product);
                    if (value === null || value < filter.value[0] || value > filter.value[1]) {
                        return false;
                    }
                }
                else if (filter.type === 'check' || filter.type === 'color') {
                    var values_1 = getListValues(filter.slug, product);
                    return filter.value.length < 1 || filter.value.reduce(function (isMatched, value) {
                        return isMatched || !!values_1.find(function (x) { return x.slug === value; });
                    }, false);
                }
                else if (filter.type === 'radio') {
                    var values = getListValues(filter.slug, product);
                    return !!values.find(function (x) { return x.slug === filter.value; });
                }
                return true;
            }
            function calcProductsForFilterValues(filter, allFilters, products) {
                var result = {};
                products = products.filter(function (product) { return allFilters.reduce(function (isMatched, eachFilter) {
                ...
                products.forEach(function (product) {
                    switch (filter.type) {
                        ...
                        case 'color':
                        case 'radio':
                            getListValues(filter.slug, product).forEach(function (value) {
            ...
            function makeFilters(filtersDef, products) {
                var result = [];
                filtersDef.forEach(function (filterDef) {
                    if (filterDef.type === 'range') {
                        var max = products.reduce(function (value, product) { return Math.max(value, getRangeValue(filterDef.slug, product, value)); }, 0);
                        var min = products.reduce(function (value, product) { return Math.min(value, getRangeValue(filterDef.slug, product, value)); }, max);
                        /** Calculates the number of digits for rounding. */
                        var digit = Math.max(Math.ceil(max).toString().length - 2, 1);
                        ...
                        var items_1 = [];
                        products.forEach(function (product) {
                            getListValues(filterDef.slug, product).forEach(function (value) {
                                if (value.slug in itemsBySlug_1) {
                                    return;
                                }
                                var item = makeFilterItem(filterDef.type, value);
                                itemsBySlug_1[value.slug] = item;
                                items_1.push(item);
                            });
                        });
                        if (items_1.length < 1 || (filterDef.type === 'radio' && items_1.length < 2)) {
                            return;
                        }
                        items_1 = sortFilterItems(filterDef.type, filterDef.slug, items_1);
                        result.push({
                            type: filterDef.type,
                            slug: filterDef.slug,
                            name: filterDef.name,
                            value: filterDef.type === 'radio' ? items_1[0].slug : [],
                            items: items_1,
                        });
                    }
                });
            ...
            function sortFilterItems(filterType, filterSlug, items) {
                if (filterType === 'color' && filterSlug === 'color') {
                    var attributeDef = _database_products__WEBPACK_IMPORTED_MODULE_4__["attributesDef"].find(function (x) { return x.slug === filterSlug; });
                    if (attributeDef) {
                        var values_2 = attributeDef.values.map(function (x) { return x.slug; });
                        return items.sort(function (a, b) {
                            return values_2.indexOf(a.slug) - values_2.indexOf(b.slug);
                        });
                    }
                }
                return items;
