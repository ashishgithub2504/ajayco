(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-shop-shop-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductSidebarComponent = /** @class */ (function () {
                function ProductSidebarComponent(shop) {
                    this.shop = shop;
                }
                ProductSidebarComponent.prototype.ngOnInit = function () {
                    this.categories$ = this.shop.getCategories(null, 1);
                    this.bestsellers$ = this.shop.getBestsellers().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (x) { return x.slice(0, 5); }));
                };
                return ProductSidebarComponent;
            }());
            ProductSidebarComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductTabsComponent = /** @class */ (function () {
                ...
                Object.defineProperty(ProductTabsComponent.prototype, "product", {
                    get: function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductsViewComponent = /** @class */ (function () {
                function ProductsViewComponent(fb, sidebar, pageService) {
                    this.fb = fb;
                ...
                ProductsViewComponent.prototype.ngOnInit = function () {
                    ...
                    this.listOptionsForm.valueChanges.subscribe(function (value) {
                        value.limit = parseFloat(value.limit);
                        _this.pageService.updateOptions(value);
                    });
                    this.pageService.list$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$)).subscribe(function (_a) {
                        var page = _a.page, limit = _a.limit, sort = _a.sort, filterValues = _a.filterValues;
                        _this.filtersCount = Object.keys(filterValues).length;
                        _this.listOptionsForm.setValue({ page: page, limit: limit, sort: sort }, { emitEvent: false });
                    });
                };
                ProductsViewComponent.prototype.ngOnDestroy = function () {
                    this.destroy$.next();
                ...
                ProductsViewComponent.prototype.resetFilters = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShopSidebarComponent = /** @class */ (function () {
                function ShopSidebarComponent(shop, sidebar, platformId) {
                    this.shop = shop;
                    this.sidebar = sidebar;
                ...
                ShopSidebarComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.bestsellers$ = this.shop.getBestsellers().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (x) { return x.slice(0, 5); }));
            ...
            var CheckoutGuard = /** @class */ (function () {
                ...
                CheckoutGuard.prototype.canActivate = function (route, state) {
                    ...
                    return this.cart.quantity$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (quantity) {
                        ...
                        _this.router.navigateByUrl('/cart').then();
                        return false;
                    }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PageCategoryComponent = /** @class */ (function () {
                function PageCategoryComponent(root, router, route, pageService, shop, location) {
                    var _this = this;
                    this.root = root;
                    this.router = router;
                    this.route = route;
                    ...
                    this.route.data.subscribe(function (data) {
                        _this.breadcrumbs = [
                            { label: 'Home', url: _this.root.home() },
                            { label: 'Shop', url: _this.root.shop() },
                        ];
                        // If categorySlug is undefined then this is a root catalog page.
                        if (!_this.getCategorySlug()) {
                            _this.pageHeader = 'Shop';
                        }
                        else {
                            _this.pageHeader = data.category.name;
                            _this.breadcrumbs = _this.breadcrumbs.concat(data.category.parents.map(function (parent) { return ({ label: parent.name, url: _this.root.category(parent) }); }).concat([
                                { label: data.category.name, url: _this.root.category(data.category) },
                            ]));
                        }
                        _this.pageService.setList(data.products);
                    ...
                    this.route.queryParams.subscribe(function (queryParams) {
                        _this.pageService.setOptions(Object(_resolvers_products_list_resolver_service__WEBPACK_IMPORTED_MODULE_9__["parseProductsListParams"])(queryParams), false);
                    });
                    this.pageService.optionsChange$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["debounce"])(function (changedOptions) {
                        ...
                        _this.updateUrl();
                        _this.pageService.setIsLoading(true);
                        return _this.shop.getProductsList(_this.getCategorySlug(), _this.pageService.options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(_this.pageService.optionsChange$));
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(this.destroy$)).subscribe(function (list) {
                        _this.pageService.setList(list);
                        _this.pageService.setIsLoading(false);
                    });
                }
                ...
                PageCategoryComponent.prototype.updateUrl = function () {
                ...
                PageCategoryComponent.prototype.getQueryParams = function () {
                    var params = {};
                    var options = this.pageService.options;
                    ...
                    if ('filterValues' in options) {
                        this.pageService.filters.forEach(function (filter) {
                            if (!(filter.slug in filterValues)) {
                                return;
                            }
                            var filterValue = Object(_shared_helpers_filter__WEBPACK_IMPORTED_MODULE_11__["parseFilterValue"])(filter.type, filterValues[filter.slug]);
                            switch (filter.type) {
                                case 'range':
                ...
                PageCategoryComponent.prototype.getCategorySlug = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PageCheckoutComponent = /** @class */ (function () {
                function PageCheckoutComponent(root, cart, route, router) {
                    this.root = root;
                    this.cart = cart;
                    this.route = route;
                    this.router = router;
                ...
                PageCheckoutComponent.prototype.pay = function (price) {
                    var options = {
                    // your options
                    };
                    options = {
                ...
                PageCheckoutComponent.prototype.paymentCapture = function (response) {
                };
            ...
            var PageCompareComponent = /** @class */ (function () {
                ...
                PageCompareComponent.prototype.ngOnInit = function () {
                    ...
                    this.compare.items$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.destroy$)).subscribe(function (products) {
                        var features = [];
                        products.forEach(function (product) { return product.attributes.forEach(function (productAttribute) {
                            var feature = features.find(function (eachFeature) { return eachFeature.name === productAttribute.name; });
                            if (!feature) {
                                feature = {
                            ...
                            feature.values[product.id] = productAttribute.values.map(function (x) { return x.name; }).join(', ');
                        }); });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PageProductComponent = /** @class */ (function () {
                function PageProductComponent(shop, route) {
                    this.shop = shop;
                    this.route = route;
                ...
                PageProductComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.route.data.subscribe(function (data) {
                        _this.layout = data.layout || _this.layout;
                        _this.sidebarPosition = data.sidebarPosition || _this.sidebarPosition;
                        _this.product = data.product;
                        _this.relatedProducts$ = _this.shop.getRelatedProducts(data.product);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CategoryResolverService = /** @class */ (function () {
                function CategoryResolverService(root, router, shop) {
                    this.root = root;
                    this.router = router;
                    this.shop = shop;
                }
                CategoryResolverService.prototype.resolve = function (route, state) {
                    var _this = this;
                    var categorySlug = route.params.categorySlug || route.data.categorySlug || null;
                    if (categorySlug === null) {
                        return null;
                    }
                    return this.shop.getCategory(categorySlug).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                        if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpErrorResponse"] && error.status === 404) {
                            _this.router.navigateByUrl(_this.root.notFound()).then();
                        }
            ...
            CategoryResolverService.ctorParameters = function () { return [
                { type: _shared_services_root_service__WEBPACK_IMPORTED_MODULE_6__["RootService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _shared_api_shop_service__WEBPACK_IMPORTED_MODULE_7__["ShopService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductResolverService = /** @class */ (function () {
                function ProductResolverService(root, router, shop) {
                    this.root = root;
                    this.router = router;
                    this.shop = shop;
                }
                ProductResolverService.prototype.resolve = function (route, state) {
                    var _this = this;
                    var productSlug = route.params.productSlug || route.data.productSlug;
                    return this.shop.getProduct(productSlug).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                        if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpErrorResponse"] && error.status === 404) {
                            _this.router.navigate([_this.root.notFound()]).then();
                        }
                        return rxjs__WEBPACK_IMPORTED_MODULE_3__["EMPTY"];
                    }));
                };
            ...
            ProductResolverService.ctorParameters = function () { return [
                { type: _shared_services_root_service__WEBPACK_IMPORTED_MODULE_6__["RootService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _shared_api_shop_service__WEBPACK_IMPORTED_MODULE_7__["ShopService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductsListResolverService = /** @class */ (function () {
                function ProductsListResolverService(root, router, shop) {
                    this.root = root;
                    this.router = router;
                    this.shop = shop;
                }
                ProductsListResolverService.prototype.resolve = function (route, state) {
                    var _this = this;
                    var categorySlug = route.params.categorySlug || route.data.categorySlug || null;
                    return this.shop.getProductsList(categorySlug, parseProductsListParams(route.queryParams)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                        if (error instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpErrorResponse"] && error.status === 404) {
                            _this.router.navigate([_this.root.notFound()]).then();
                        }
                        return rxjs__WEBPACK_IMPORTED_MODULE_3__["EMPTY"];
                ...
                return ProductsListResolverService;
            }());
            ProductsListResolverService.ctorParameters = function () { return [
                { type: _shared_services_root_service__WEBPACK_IMPORTED_MODULE_6__["RootService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
                { type: _shared_api_shop_service__WEBPACK_IMPORTED_MODULE_7__["ShopService"] }
            ]; };
